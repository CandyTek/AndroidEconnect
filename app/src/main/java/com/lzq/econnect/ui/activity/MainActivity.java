...
public class MainActivity extends BaseActivity {
	...
	private View.OnClickListener tbListener = new View.OnClickListener() {
		...
		public void onClick(View v) {
            int id = v.getId();
            if (id == R.id.toolbar_btn1) {
                updateToolbarUi(0);
                mainPager.setCurrentItem(0);
            } else if (id == R.id.toolbar_btn2) {
                updateToolbarUi(1);
                mainPager.setCurrentItem(1);
            } else if (id == R.id.toolbar_btn3) {
                updateToolbarUi(2);
	...
	private void initView() {
		...
		toolbarBtn1 = findViewById(R.id.toolbar_btn1);
		toolbarBtn2 = findViewById(R.id.toolbar_btn2);
		toolbarBtn3 = findViewById(R.id.toolbar_btn3);
		mDrawerLayout = findViewById(R.id.draw_layout);
		coordinatorLayout = findViewById(R.id.coordinator_layout);
		mainPager = findViewById(R.id.main_pager);
		ldLayout = findViewById(R.id.ld_layout);
		lvLeftMenu = findViewById(R.id.left_drawer_listview);
	}
